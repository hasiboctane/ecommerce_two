<div x-data="{
    ...
    slides: [{
        ...
        {
            imgSrc: '{{ asset('images/ladies.jpg') }}',
...
}" x-init="autoplay" class="relative w-full pt-[72px] md:pt-[74px] overflow-hidden">

    <!-- slides -->
    <!-- Change min-h-[50svh] to your preferred height size -->
    <div class="relative h-[50vh] md:h-[90vh] min-h-[50svh] w-full">
            ...
            <div x-cloak x-show="currentSlideIndex == index + 1" class="absolute inset-0"
                ...
                <div
                    ...
                    <button type="button" x-cloak x-show="slide.ctaUrl !== null"
                        class="mt-2 mb-14 cursor-pointer whitespace-nowrap rounded-xl border border-rose-700 hover:border-white bg-transparent hover:bg-rose-700 px-4 py-2 text-center text-xs font-medium tracking-wide text-rose-50 transition hover:opacity-75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-onSurfaceDarkStrong active:opacity-100 active:outline-offset-0 md:text-sm"
