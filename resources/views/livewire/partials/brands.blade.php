<section class="py-20">
    ...
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2 content-around">
            @foreach ($brands as $brand)
                <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $brand->id }}">
                    <a href="/products?selected_brands[0]={{ $brand->id }}" wire:navigate class="">
                        ...
                        @else
                            <img src="{{ asset('images/null.jpg') }}" alt=""
                                class="object-cover w-full h-64 rounded-t-lg">
                        @endif
                    </a>
                    <div class="p-5 text-center">
                        <a href="/products?selected_brands[0]={{ $brand->id }}" wire:navigate
