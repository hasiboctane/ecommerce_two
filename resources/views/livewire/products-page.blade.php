            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div class="text-xl font-bold text-rose-600">{{ Number::currency($price_range, 'BDT') }}</div>
                        <div>
                            <input type="range"
                                class="w-full h-1 mb-4 bg-rose-100 rounded appearance-none cursor-pointer"
                                max="10000" value="{{ $price_range }}" step="500"
                                wire:model.live='price_range'>
                            <div class="flex justify-between ">
                                <span class="inline-block text-md font-bold text-slate-600 ">500</span>
                                <span class="inline-block text-md font-bold text-slate-600 ">10000</span>
                            </div>
                        </div>
                    </div>
                </div>
