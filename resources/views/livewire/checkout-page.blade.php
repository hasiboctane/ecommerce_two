<div class="w-full max-w-[85rem] py-24 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <form wire:submit.prevent="placeOrder">
        <div class="grid grid-cols-12 gap-4">
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                <!-- Card -->
                <div class="bg-white rounded-md shadow p-4 sm:p-7 dark:bg-slate-900">
                    <!-- Shipping Address -->
                    <div class="mb-6">
                    ...
                    <ul class="grid w-full gap-6 md:grid-cols-2">
                        <li>
                            <input wire:model="payment_method" class="hidden peer" id="cod" type="radio"
                                value="cod" />
                            <label
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <div class="bg-white rounded-md shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <hr class="bg-slate-400 my-4 h-0.5 rounded">
                    <div class="flex justify-between mb-2 font-semibold">
                        <span>
                            Grand Total
                        </span>
