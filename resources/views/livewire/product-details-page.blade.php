<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="overflow-hidden bg-cyan-50 py-11 font-poppins dark:bg-gray-800">
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-4/5 mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ $product->images ? url('storage', $product->images[0]) : asset('images/null.jpg') }}' }">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            <h2 class="max-w-xl mb-4 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                                {{ $product->name }}</h2>
                            <p class="inline-block mb-6 text-2xl font-semibold text-gray-700 dark:text-gray-400 ">
